...
const Step2AddServices = ({secondStep, countries}) => {
	const router = useRouter();
	const xIcon = <IconX style={{width: rem(20), height: rem(20)}}/>;
	logger.info(`Step2AddServices - secondStep: ${secondStep}`);
					...
					<form onSubmit={handleSubmit((data, event) => onSubmit(data, event))}>
						<div className="space-y-12">
							...
							<div
								...
								<div
									className="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-1">
											...
											<div className="sm:col-span-4">
												...
												<div className="mt-2">
													...
													>
														...
														{!isLoadingSites && secondStep.siteOptions.map((option) => (
															<option key={option.id}
																	value={option.value}>{option.code}</option>
														))}
													</select>
												</div>
											</div>
									...
									{(styles) => (
										<FocusTrap active={farFocusActive}>
											<div
												...
												<Group justify="left">
													<Code color="blue.9" c="blue">FAR side</Code>
												</Group>
							...
							<div
								...
								<div>
									...
									<p className="mt-1 text-sm leading-6 text-gray-600">
										Add the services required to your Order.
									</p>
								</div>
								<div
												...
												<div className="mt-6 space-y-6">
													...
													<div className="flex items-center gap-x-3">
														...
														{showFARSelectionWarning && (!farCountry || !farSiteCode) ? (
															...
															>
																Please select the FAR location details above to
																request
																this service.
															</Alert>
														) : (
													...
													{secondStep.services.map((service, index) => (
														<Fragment key={index}>
															<Modal
																...
																{(service.workRequired === 'SEN Data' ||
																	service.workRequired === 'Media Data') ? (
																	<SENDataSection
																		key={index}
																		index={index}
...
export default Step2AddServices;
